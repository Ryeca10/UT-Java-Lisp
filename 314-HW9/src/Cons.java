...
// empty buffers into a music string
    ...
    public static Cons vars (Object expr) {
    	...
    	if (expr != null && consp(expr)  && rest((Cons)expr) != null)
    	{
    			return union (vars(first((Cons)expr)), vars(rest((Cons)expr)));
    	}
    	
    	else if (expr != null && consp(expr) && rest((Cons)expr) == null)
    	{
    		Object last = first((Cons)expr);
    		return vars(last);
    	}
    	
    	else if ( expr != null && !numberp(expr) && !expr.equals("expt")
    							&& !expr.equals("exp")
    							&& !expr.equals("+")
    							&& !expr.equals("-")
    							&& !expr.equals("*")
    ...
    public static Cons solve(Cons e, String v) {
    	...
    	{
    		return new Cons(op(e),new Cons(rhs(e), new Cons(lhs(e),null)));
    	}
    	...
    	else if (consp(rhs(e)))
    	{
    		...
    		{		
    			if (rhs((Cons)rhs(e)) == null)
    			{
    				...
    				e = list("=", list (op((Cons)rhs(e)), lhs(e)), lhs((Cons)rhs(e)));
    			}
    			
    			else
    			{
    				String inv = (String)lhs(assoc(op((Cons)rhs(e)),inverse));
    				e = list("=", v , list(inv , lhs(e) , rhs((Cons)rhs(e))));
    			}
    		...
    		{
    				String inv = (String)lhs(assoc(op((Cons)rhs(e)),inverse));
    				e = list("=", list (inv, lhs(e), rhs((Cons)rhs(e))), lhs((Cons)rhs(e)));
    		...
    		{
    			String inv = (String)lhs(assoc(op((Cons)rhs(e)),inverse));
    			e = list ("=", v , list(inv, lhs(e), lhs((Cons)rhs(e))));
    			return solve(e,v);
    		}
    		...
    		else
    		{
    			...
    			if (op((Cons)rhs(e)).equals("-"))
    			{
    				...
    				e = list("=", list(inv,lhs(e)), lhs((Cons)rhs(e)));
    			...
    			{
    				e = list("=", list (inv, lhs(e), 2), lhs((Cons)rhs(e)), rhs((Cons)rhs(e)));
    			}
    			...
    			else
    			{
    					...
    					e = list("=", list (inv, lhs(e), lhs((Cons)rhs(e))), rhs((Cons)rhs(e)));
    	...
    	else if (consp(lhs(e)) && member(rhs(e),variables) != null)
		{
    		e = list("=",rhs(e),lhs(e));
